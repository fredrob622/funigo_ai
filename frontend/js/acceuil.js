...
// TweenMax.from(titreH1, 1, {scale: 4, width:"400", x:"400", opacity:0, delay:1});
// TweenMax.to(titreH1, 1, {scale: 1, width:"800",  opacity:0, delay:1});
// TweenMax.to(titreH1, 1, {scale: 1, x:"800",  opacity:1, delay:2});
