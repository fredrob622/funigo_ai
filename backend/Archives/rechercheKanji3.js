...
router.use(express.static('icones'));
router.use(express.static('html'));
router.use(express.static('IHM'));
...
router.post('/api/rechercheKanji3', function(req, res, next) {
    ...
    db.query( reqSql, function (err, result) {
        ...
        // rechercheKanji3 => fichier rechercheKanji3.ejs
        // res.status(200).render('rechercheKanji3', { result }); // pour ejs
